...
#         shoulder_center_count = (0, 0)
    ...
    res = ImQzAnalysis(file_key = fileKey, user_key = userKey, qz_group = qzGroup, qz_num = qzNum, group_code = groupCode, face_check = Face_analy_result,
                       ...
                       center_shoulder_right_move_count = sshoulder_horizontality_count_value[1], left_hand = json.dumps(left_hand_dict), left_hand_time = Left_Hand_time, left_hand_move_count = Left_Hand_count,
