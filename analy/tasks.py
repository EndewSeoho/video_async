...
#     shoulder_right_count = Average.shoulder_right_count(shoulder_vertically_right_count)
    ...
    res = ImQzAnalysis(file_key = fileKey, user_key = userKey, qz_group = qzGroup, qz_num = qzNum, group_code = groupCode, face_check = Face_analy_result,
                       ...
                       right_shoulder = json.dumps(right_shoulder_dict), right_shoulder_move_count = shoulder_right_count, center_shoulder = json.dumps(center_shoulder_dict), center_shoulder_left_move_count = shoulder_center_count[0],
                       center_shoulder_right_move_count = shoulder_center_count[1], left_hand = json.dumps(left_hand_dict), left_hand_time = Left_Hand_time, left_hand_move_count = Left_Hand_count,
